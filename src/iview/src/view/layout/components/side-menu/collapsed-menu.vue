<template>
  <hf-dropdown ref="dropdown"
    ...
    <a class="drop-menu-a" type="text" @mouseover="handleMousemove($event, children)"
      ...
      <hf-icon class="right" v-if="!hideTitle" type="ios-arrow-forward" :size="16"></hf-icon>
    </a>
    <hf-dropdown-menu ref="dropdown" slot="list">
      <template v-for="child in children">
        ...
        <hf-dropdown-item v-else :key="`drop-${child.name}`" :name="child.name">
